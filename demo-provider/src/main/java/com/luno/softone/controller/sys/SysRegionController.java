...
import com.luno.softone.common.utils.TreeUtils;
import com.luno.softone.model.entity.SysRegionEntity;
import com.luno.softone.service.SysRegionService;
...
public class SysRegionController {
    ...
    public R getAllCountry() {
        List<SysRegionEntity> list = null;//RegionCacheUtil.getAllCountry();
    ...
    public R getAllProvice(@RequestParam(required = false) Integer areaId) {
        List<SysRegionEntity> list = null;//RegionCacheUtil.getAllProviceByParentId(areaId);
        return R.ok().put("list", list);
    }
    ...
    public R getAllCity(@RequestParam(required = false) Integer areaId) {
        List<SysRegionEntity> list = null;//RegionCacheUtil.getChildrenCity(areaId);
        return R.ok().put("list", list);
    }
    ...
    public R getChildrenDistrict(@RequestParam(required = false) Integer areaId) {
        List<SysRegionEntity> list = null;//RegionCacheUtil.getChildrenDistrict(areaId);
        return R.ok().put("list", list);
    }
    ...
    public R getAreaTree() {
        List<SysRegionEntity> list = null;//RegionCacheUtil.sysRegionEntityList;
    ...
    public R getAreaByType(@RequestParam(required = false) Integer type) {
        ...
        if (type.equals(0)) {
            ...
            list = null;//RegionCacheUtil.getAllCountry();
        } else if (type.equals(2)) {
            list = null;//RegionCacheUtil.getAllProvice();
        } else if (type.equals(3)) {
            list = null;//RegionCacheUtil.getAllCity();
        }
        return R.ok().put("list", list);
    }
}
